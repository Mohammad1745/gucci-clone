...
Route::get('/dashboard/editProduct/{id}',[ProductController::class,'editProduct'])->name('editProduct');
Route::post('/dashboard/updateProduct',[ProductController::class,'updateProduct'])->name('updateProduct');
Route::post('/dashboard/delete-product/{id}',[ProductController::class,'deleteProduct'])->name('deleteProduct');

    Route::get('/dashboard/currentOrder', [ProductController::class, 'currentOrder'])->name('currentOrder');
